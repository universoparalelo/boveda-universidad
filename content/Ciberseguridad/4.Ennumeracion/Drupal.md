...
## Caso practico
Descargar el repo de [Drupal/CVE-2018](https://github.com/vulhub/vulhub/tree/master/drupal/CVE-2018-7600)
```bash
svn checkout https://github.com/vulhub/vulhub/trunk/drupal/CVE-2018-7600
cd CVE-2018-7600
docker-compose up -d
```
